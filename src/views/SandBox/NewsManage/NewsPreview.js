...
export default function NewsPreview(props) {
    ...
    let auditList = ['未审核', '审核中', '已通过', '未通过']
    let publishList = ['未发布', '待发布', '已上线', '已下线']
        ...
        <div>
            {
                ...
                <div>
                    ...
                    <div style={{ border: '1px solid #999', padding: '10px', margin: '0 24px' }} dangerouslySetInnerHTML={{ __html: newsInfo.content }}></div>
                </div>
            }
        </div>
    )
