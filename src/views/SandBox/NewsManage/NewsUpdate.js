...
const { Step } = Steps;
const { Option } = Select;
export default function NewsUpate(props) {
        ...
        <div>
            ...
            <div style={{ margin: "50px 0" }}>
                <div className={current === 0 ? '' : style.active}>
                    <Form ref={NewsForm} {...layout} name="control-hooks" onFinish={onFinish}>
                        ...
                        <Form.Item name="categoryId" label="新闻分类" rules={[{ required: true, message: '新闻分类不能为空！' }]}>
                            <Select placeholder="请选择新闻分类" onChange={onGenderChange} allowClear>
                                {
